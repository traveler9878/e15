                ...
                <li>
                    ...
                    @else
                        <form method='POST' id='logout' action='/logout'>
                            ...
                            {{-- 
                        Codeception can’t invoke our JavaScript so instead of a link that acts as a submit button, we'll use a button that's styled like a link to submit this form.
